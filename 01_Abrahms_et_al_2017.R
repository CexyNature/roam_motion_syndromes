...
filename_reloc <- paste("figures/simulated_individuals/central_reloc", suffix, ".png")
filename_hist <- paste("figures/simulated_individuals/central_hist", suffix, ".png")

plot(df.central[,1], df.central[,2], type='b', 
     main = "Movement path (relocations)",
     xlab = "Longitude",
     ylab = "Latitude")
dev.copy(png, filename_reloc)
dev.off()

hist(df.central[,3], 
     main = "Histogram of Distance from HR center",
     xlab = "Distance from center")
dev.copy(png, filename_hist)
dev.off()
...
filename_reloc <- paste("figures/simulated_individuals/nomad_reloc", suffix, ".png")
filename_hist <- paste("figures/simulated_individuals/nomad_hist", suffix, ".png")
...
filename_reloc <- paste("figures/simulated_individuals/territorial_reloc", suffix, ".png")
filename_hist <- paste("figures/simulated_individuals/territorial_hist", suffix, ".png")
...
filename_reloc <- paste("figures/simulated_individuals/migrant_reloc", suffix, ".png")
filename_hist <- paste("figures/simulated_individuals/migrant_hist", suffix, ".png")
...
############ ============ New section ============= ############
# Save data
saveRDS(df.central, paste("data/simulated_individuals/central", suffix, ".Rds"))
saveRDS(df.migrant, paste("data/simulated_individuals/migrant1", suffix, ".Rds"))
saveRDS(df.nomad, paste("data/simulated_individuals/nomad1", suffix, ".Rds"))
saveRDS(df.territorial, paste("data/simulated_individuals/territorial1", suffix, ".Rds"))
